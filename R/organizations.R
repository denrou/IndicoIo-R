...
#'   cat("A year ago, the New York Times published confidential comments about",
#'       "ISIS' ideology by Major General Michael K. Nagata, then U.S. Special",
#'       "Operations commander in the Middle East."))
